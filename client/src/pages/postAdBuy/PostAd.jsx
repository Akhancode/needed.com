...
const PostAd = () => {
    ...
    const createAd = async (e) =>{
        ...
        const res = await axios.post('http://localhost:8000/api/v1/buyers/ads/create',formData, { withCredentials: true }).then(
    ...
    const getAllCategory =  async () => {
         ...
         await axios.get('http://localhost:8000/api/v1/admin/category/all', { withCredentials: true }).then(
             (res)=>{
